...
const init_phones = ["IEM HP.com DF Target"],// Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      page_title = "SylvieGraph",                   // Optional. Appended to the page title if share URLs are enabled
      page_description = "",
      ...
      extraEQBands = 1,                             // Default EQ bands available
...
const  preference_bounds_name = "Bounds",              // Preference bounds name
       ...
       default_DF_name = "IEM HP.com DF",              // Default RAW DF name
       ...
       tiltableTargets = ["IEM HP.com DF",          // Targets that are allowed to be tilted
                            "Delta",
                            "JM-1",
                            "Flat",
                            "ISO 11904-1 DF (711 Z)"],
       compTargets = ["IEM HP.com DF"               // Targets that are allowed to be used for compensation
                            ,"Delta"
                            ,"JM-1"
                            ,"Flat"
                            ,"ISO 11904-1 DF (711 Z)"],
...
const linkSets = [
    {
        ...
        links: [
            ...
            {
                name: "Earphone Archive 5128",
                url: "https://earphonesarchive.squig.link"
            },
            {
                name: "Super 711",
    ...
    },
    {
        ...
        links: [
            {
                name: "Listener 5128 HP",
                url: "https://listener800.github.io/5128hp.html"
            },
            {
                name: "Listener KB006x HP",
                url: "https://listener800.github.io/?share=KEMAR_DF_(KB006x)_Target"
            },
            {
                name: "Hangout 5128 HP",
                url: "https://graph.hangout.audio/iem/5128"
            },
            {
                name: "Earphone Archive 5128 HP",
...
let headerLogoText = "Sylvie",
    headerLogoImgUrl = "https://avatars.fastly.steamstatic.com/21228e72737d70cfe49ab146a628cf36dc8b5edd_full.jpg",
    headerLinks = [];
